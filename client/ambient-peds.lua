...
function CasinoPeds()
    ...
    ped = CreatePed(0, model ,990.3, 29.8, 70.2, true)
    FreezeEntityPosition(ped, true)
    SetEntityHeading(ped, 80.052 )
    SetEntityInvincible(ped, true)
    SetBlockingOfNonTemporaryEvents(ped, true)
    TaskStartScenarioInPlace(ped, "PROP_HUMAN_SEAT_CHAIR", 0, true)
    
    model = GetHashKey("ig_tomcasino")
    RequestModel(model)
    while not HasModelLoaded(model) do
        Wait(1)
    end
    ped = CreatePed(0, model , 990.6, 31.0, 70.2, true)
    FreezeEntityPosition(ped, true)
    SetEntityHeading(ped, 55.00)
    SetEntityInvincible(ped, true)
    SetBlockingOfNonTemporaryEvents(ped, true)
    TaskStartScenarioInPlace(ped, "PROP_HUMAN_SEAT_CHAIR_UPRIGHT", 0, true)

    model = GetHashKey("a_m_y_smartcaspat_01")
    RequestModel(model)
    while not HasModelLoaded(model) do
        Wait(1)
    end
    ped = CreatePed(0, model , 991.5, 31.9, 70.2, true)
    FreezeEntityPosition(ped, true)
    SetEntityHeading(ped, 30.41)
    SetEntityInvincible(ped, true)
    SetBlockingOfNonTemporaryEvents(ped, true)
    TaskStartScenarioInPlace(ped, "PROP_HUMAN_SEAT_CHAIR_UPRIGHT", 0, true)
     ...
     ped = CreatePed(0, model , 927.5357, 52.23334, 80.096, true)
     FreezeEntityPosition(ped, true)
     SetEntityHeading(ped, 62.60)
     SetEntityInvincible(ped, true)
     SetBlockingOfNonTemporaryEvents(ped, true)
     ...
     ped = CreatePed(0, model , 921.1276, 41.73143, 80.096, true)
     FreezeEntityPosition(ped, true)
     SetEntityHeading(ped, 62.60)
     SetEntityInvincible(ped, true)
     SetBlockingOfNonTemporaryEvents(ped, true)
     ...
     model = GetHashKey("ig_bankman")
     RequestModel(model)
     while not HasModelLoaded(model) do
         Wait(1)
     end
     ped = CreatePed(0, model , 934.2938, 36.86325, 80.100, true)
     FreezeEntityPosition(ped, true)
     SetEntityHeading(ped, 62.60)
     SetEntityInvincible(ped, true)
     SetBlockingOfNonTemporaryEvents(ped, true)
     ...
     model = GetHashKey("a_f_y_business_01")
     RequestModel(model)
     while not HasModelLoaded(model) do
         Wait(1)
     end
     ped = CreatePed(0, model , 953.200, 21.4, 70.375, true)
     FreezeEntityPosition(ped, true)
     SetEntityHeading(ped, 351.1)
     SetEntityInvincible(ped, true)
     SetBlockingOfNonTemporaryEvents(ped, true)
     TaskStartScenarioInPlace(ped, "PROP_HUMAN_SEAT_BUS_STOP_WAIT", 0, true)
     ...
     ped = CreatePed(0, model , 975.9, 23.10039, 70.184, true)
     FreezeEntityPosition(ped, true)
     SetEntityHeading(ped, 285.8)
     SetEntityInvincible(ped, true)
     SetBlockingOfNonTemporaryEvents(ped, true)
     TaskStartScenarioInPlace(ped, "PROP_HUMAN_SEAT_CHAIR_DRINK_BEER", 0, true)
     ...
     ped = CreatePed(0, model , 965.3107, 48.08510, 70.700, true)
     FreezeEntityPosition(ped, true)
     SetEntityHeading(ped, 152.7)
     SetEntityInvincible(ped, true)
     SetBlockingOfNonTemporaryEvents(ped, true)
     TaskStartScenarioInPlace(ped, "WORLD_HUMAN_STAND_IMPATIENT", 0, true)
